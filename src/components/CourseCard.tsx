 ...
 *
 * This component displays a card with information about a course, including the course name,
 * number of students, and average grade. It also highlights the card if it is selected.
 *
...
export const CourseCard: React.FC<CourseCardProps> = ({
  ...
  // Calculate the average grade of the students in the course
  const averageGrade =
